...
/**
 *  The <tt>MultiwayIndexMinHeap</tt> class represents an indexed priority queue of generic keys.
 ...
 *  @author Kevin Wayne
 */
public class MultiwayIndexMinHeap<Key extends Comparable<Key>> implements Iterable<Integer> {
     ...
     */
    public MultiwayIndexMinHeap(int NMAX) {
    ...
    **********************************************************************/
    ...
    private class HeapIterator implements Iterator<Integer> {
        // create a new pq
        private MultiwayIndexMinHeap<Key> copy;

        // add all elements to copy of heap
        // takes linear time since already in heap order so no keys move
        public HeapIterator() {
            copy = new MultiwayIndexMinHeap<Key>(pq.length - 1);
            for (int i = 1; i <= N; i++)
    ...
    /**
     * Unit tests the <tt>MultiwayIndexMinHeap</tt> data type.
     */
    public static void main(String[] args) {
        // insert a bunch of strings
        String[] strings = { "it", "was", "the", "best", "of", "times", "it", "was", "the", "worst" };

        MultiwayIndexMinHeap<String> pq = new MultiwayIndexMinHeap<String>(strings.length);
